...
if __name__ == "__main__":
    ...
    model_path = os.path.join(os.getcwd(), 'FinalProject','nfl_predictor.model')
    weights_path = os.path.join(os.getcwd(), 'FinalProject','weights_best.hdf5')
    # print(model_path)
    # print(weights_path)

    nfl = NFLPredictor(model_path, weights_path)
    result = nfl.predict('Oakland Raiders', 'Pittsburgh Steelers', 1, 'superbowl')
